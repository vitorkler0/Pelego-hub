                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script Pelego Hub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
setclipboard("Pelego Hub Is The Best")
...
Tabs.Main:AddButton({
        Title = "Pelego Hub Discord Server",
...
Fluent:Notify({
    Title = "Pelego Hub",
    Content = "Thanks For Using Pelego Hub",
    Duration = 8
})
